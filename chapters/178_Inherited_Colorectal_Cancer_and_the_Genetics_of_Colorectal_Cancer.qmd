...
{{< reveal Volume_2/178_Inherited_Colorectal_Cancer_and_the_Genetics_of_Colorectal_Cancer >}}


{{< reveal Extras/colorectal/178_jsccr_hereditary >}}


{{< reveal Extras/colorectal/178_nccn_2024_hereditary >}}

{{< reveal Extras/colorectal/178_nccn_genetics_colorectal >}}


```{r}
#| label: CRC classification by polyp burden
#| echo: false
...
```{r}
#| label: CRC classification by histological types
#| echo: false
...
```{r}
#| label: CRC classification by mode of inheritance
#| echo: false
...
```{r}
#| label: Hamartomatous polyposis syndromes
#| echo: false
...
# =============================================================================
# MODERN SLIDE-READY FLOW DIAGRAM
# =============================================================================
...
def diamond(x, y, s, text, fc, ec=None, tc='white', fs=10):
...
box(
    8, 7.15, 9.5, 0.75,
    'Surveillance Targets\nRectum  •  Ileal Pouch  •  ATZ  •  End Ileostomy',
    C['softblue'],
    ec=C['blue'],
    tc=C['dark'],
    fs=11
...
arrow(5.1, 5.95, 5.7, 5.95)

# RIGHT INFO
box(
    13.0, 5.95, 4.8, 1.15,
    'ATZ Adenomas\n\n'
    '• May exist at surgery\n'
    '• Rapid formation\n'
    '• ↑ after stapled IPAA\n'
    '• Malignant potential',
    C['softorange'],
...
# =============================================================================
# RIGHT COMPLEX PATHWAY
# =============================================================================

arrow(8.8, 4.35, 10.5, 4.35)
...
box(
    12.6, 2.0, 5.2, 0.8,
    'Formal Redo IPAA\nwith Transabdominal Pouch Mobilization',
    C['yellow'],
    ec='#D97706',
    tc=C['dark'],
    fs=10
...
arrow(12.6, 1.6, 12.6, 1.2)

box(
    12.6, 0.85, 5.8, 0.9,
    'Preferred Redo Technique:  Transanal Approach\n• Resect half the circumference initially\n• Complete other half after ATZ heals from the first procedure',
    C['softgreen'],
    ec=C['green'],
    tc=C['dark'],
    fs=10
